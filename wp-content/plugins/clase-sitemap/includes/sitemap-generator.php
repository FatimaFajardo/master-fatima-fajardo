...
echo '<a class="exitbutton" href="' . $rutita . '/sitemap-page.xml" target="_blank">Comprobar Sitemap</a>';
$dompage->save('sitemap-page.xml') or die('XML Create Error');
...
$sitemap_url = 'https://master-fatima-fajardo.test/generador-de-sitemap/';
